...
/**
 * sorted_list - A funct that inserts a new node in sorted hash table
...
/**
 * shash_table_create - A funct that creates a sorted hash tables
...
/**
 * shash_table_set - A funct that adds an element to the sorted hash table
...
/**
 * shash_table_get - A funct that retrieves the value associeted with the key
...
/**
 * shash_table_print - The funct that prints the key value from ht
 * @ht: pointer to hash table
 */
...
/**
 * shash_table_print_rev - A funct that prints the key value from ht in reverse
 * @ht: pointer to hash table
 */
...
/**
 * shash_table_delete - A funct that frees the hash table and all nodes
